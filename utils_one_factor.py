...
p1f = open('./temp2/' + 'result.pearson' + '.txt', 'w+')
s1f = open('./temp2/' + 'result.spearman' + '.txt', 'w+')
...
p1f_p = open('./temp2/pvalue/' + 'result.pearson' + '.txt', 'w+')
s1f_p = open('./temp2/pvalue/' + 'result.spearman' + '.txt', 'w+')
