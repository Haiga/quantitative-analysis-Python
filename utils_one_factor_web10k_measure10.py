...
p1f = open('./t100/' + 'result.pearson' + '.txt', 'w+')
s1f = open('./t100/' + 'result.spearman' + '.txt', 'w+')
...
p1f_p = open('./t100/pvalue/' + 'result.pearson' + '.txt', 'w+')
s1f_p = open('./t100/pvalue/' + 'result.spearman' + '.txt', 'w+')
...
for r in range(num_replicacoes):
    ...
    print(r)
    my_slice_docs = random.sample(range(num_amostras), int(0.2 * num_amostras))
